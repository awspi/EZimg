  ...
  <div class="relative h-screen bg-white dark:bg-zinc-800 text-center xl:bg-zinc-200">
    ...
    <div
      ...
      <vee-form @submit="onRegister">
        <!-- 用户名 -->
        <vee-field v-model="regForm.username"
        ...
        <!-- 密码 -->
        <vee-field v-model="regForm.password"
          class="dark:bg-zinc-800 dark:text-zinc-400 border-b-zinc-400 border-b outline-0 w-full pb-1 px-1 text-base focus:border-b-main dark:border-b-zinc-200 xl:default:bg-zinc-900"
        ...
        <!-- 确认密码 -->
        <vee-field v-model="regForm.confirmPassword"
          class="dark:bg-zinc-800 dark:text-zinc-400 border-b-zinc-400 border-b outline-0 w-full pb-1 px-1 text-base focus:border-b-main dark:border-b-zinc-200 xl:default:bg-zinc-900"
          type="password" name="confirmPassword" placeholder="确认密码" autocomplete="on"
        ...
        <div class="pt-1 pb-3 leading-[0px] text-right">
          ...
          <div class="pt-1 pb-3 leading-[0px] text-right" @click="onToLogin">
            <a
              class="inline-block p-1 text-zinc-400 text-right dark:text-zinc-600 hover:text-zinc-600 dark:hover:text-zinc-400 text-sm duration-300 cursor-pointer">去登录</a>
          </div>
          <!-- 用户协议 -->
          <div class="text-center">
            <a class="text-zinc-400 dark:text-zinc-600 hover:text-zinc-600 dark:hover:text-zinc-400 text-sm duration-400"
              href="https://baidu.com" target="__black">
              注册即同意《注册协议》
            </a>
          </div>
        </div>
        <!-- 注册按钮  -->
        <m-button :loading="loading" :isActiveAnim="false" class="w-full dark:bg-zinc-900 xl:dark:bg-zinc-900">注册
        </m-button>
      </vee-form>
    </div>
  </div>
