<template>
  <div>
    ...
    <transition name="up">
      <div v-if="isVisible"
        class="w-[80px] fixed top-[15%] left-[50%] translate-x-[-50%] z-50 px-2 py-1.5 rounded-sm border dark:boarder-zinc-600 cursor-pointer bg-white dark:bg-zinc-800 xl:w-[35%]">
        <!-- 标题 -->
